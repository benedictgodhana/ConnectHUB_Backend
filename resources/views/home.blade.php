...
<head>
	...
	<title>Connect Hub - Employee Profile</title>
	...
	<link rel="shortcut icon" href="images/ico/connect.png">
			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function">
				...
				<div class="container">
					...
					<div class="logo-wrapper">
						<div class="logo">
						<a href="./"><img style="max-width:60px" src="img/connect.png" alt="Logo" /></a>
						</div>
					</div>
                        ...
                        <form method="POST" action="{{ route('logout') }}">
                            ...
                            <a href="route('logout')"
                                    onclick="event.preventDefault();
                                                this.closest('form').submit();"><span class="material-icons md-48 align-middle"></span>
                                {{ __('Log Out') }}
                            </a>
                        </form>
						</ul>
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<div class="admin-section-title">
										...
										<h2>Profile</h2>
										<p>Your last loged-in: <span class="text-primary"></span></p>
											...
											<div class="row gap-20">
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														...
														<input name="fname" required type="text" class="form-control"  placeholder="Enter your first name">
													</div>
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														...
														<input name="lname" required type="text" class="form-control"  placeholder="Enter your last name">
													</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-6 col-md-4">
                                                    <input  name="education" type="text" required class="form-control" placeholder="Eg: Diploma, Degree...etc">
													</div>
													
													<div class="col-sm-6 col-md-4">
														<input  name="title" required type="text" class="form-control mb-15" placeholder="Eg: Computer Science, IT...etc">
													</div>
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														<label>Street</label>
														<input name="street" required type="text" class="form-control" value="">
													</div>
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														...
														<input name="zip" required type="text" class="form-control" value="">
													</div>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														...
														<textarea name="about" class="bootstrap3-wysihtml5 form-control" placeholder="Enter your short description ..." style="height: 200px;"></textarea>
													</div>
