...
<head>
	...
	<title>ConnectHub - Contact Us</title>
	...
	<link rel="shortcut icon" href="images/connect.png">
			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function">
				...
				<div class="container">
					...
					<div class="logo-wrapper">
						<div class="logo">
						<a href="./"><img style="max-width:60px" src="images/connect.png" alt="Logo" /></a>
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5>Address</h5>
										<address>Nairobi, <br/> PO.BOX AX40, <br/>Westlands</address>
								</li>
								<li>
										<h5>Email</h5><a href="benedictgodhana7@gmail.com">Connecthub@gmail.com</a>
								</li>
								<li>
										<h5>Phone Number</h5><a href="tel:+254 748 843 704">+254 748 843 704</a>
								</li>
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About Connect Hub</h5>
											<p>Connect Hub is a job portal, online job management system developed by Benedict Godhana for his project in July 2023.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<h5 class="footer-title">Connect Hub Jobs Contact</h5>
								
								<p>Address : Moi Avenue, Nairobi PO.BOX AX40</p>
								<p>Email : <a href="mailto:nightingale.nath2@gmail.com">info@connecthub.com</a></p>
								<p>Phone : <a href="tel:+254 48843704">+254 48843704</a></p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?>BenKha</p>
							...
							<div class="col-sm-4 col-md-4">
								...
								<ul class="bottom-footer-menu">
									<li><a >Developed by Benedict Godhana</a></li>
								</ul>
